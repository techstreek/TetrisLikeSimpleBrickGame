...
import com.kobakei.ratethisapp.*;

import classic_tetris.blockgame.R;
import classic_tetris.blockgame.classes.CustomAppCompatActivity;
import classic_tetris.blockgame.classes.Game;
import classic_tetris.blockgame.surfaceViews.GameView1;
import classic_tetris.blockgame.surfaceViews.GameView2;
import classic_tetris.blockgame.ui.about.AboutActivity;
...
//                .setLaunchTimes((byte) 0)   //3               // default is 10, 3 means app is launched 3 or more times
...
//        AppRate.showRateDialogIfMeetsConditions(this); // Shows the Rate Dialog when conditions are met
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.item1) {
            ...
            startActivityForResult(new Intent(getApplicationContext(), Privacy.class), 0);
        }
